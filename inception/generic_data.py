...
class GenericData(Dataset):
  ...
  def __init__(self, subset):
    super(GenericData, self).__init__('Generic', subset)
  ...
  def download_message(self):
    ...
    print('Failed to find any Generic %s files'% self.subset)
    print('')
    ...
    print('Please see README.md for instructions on how to build '
          'the generic dataset using download_and_preprocess_generic.\n')
